...
module.exports = function(stylus, setup, compile){
  ...
  setup.exclude     = setup.exclude ? new RegExp(setup.exclude) : /^\.|^_|^index|^node_modules/;
          ...
          compile(str, options).render(function(err, css){
            ...
            if (err) {
              ...
              if (responsiveSplitter.fileArray.length > 1) {
                 ...
                 debuglog('responsiveSplitter FILES'.red, responsiveSplitter.fileArray.length, responsiveSplitter.fileArray);
